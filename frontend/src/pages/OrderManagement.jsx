...
const OrderManagement = () => {
    ...
    return (
        <div className="flex font-kulim">
            <Sidebar activated="orders" />
            <div className="flex-1 flex flex-col">
                <Topbar />
                <main className="p-6 bg-white flex-1 font-kulim">
                    <header className="flex justify-between items-center">
                        <h1 className="text-3xl font-bold text-[#351108] mt-5 mb-8">Order Dashboard</h1>
                    </header>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-6">
                        {[
                            ...
                            <div key={index} className={`p-5 rounded-lg shadow-md flex items-center ${stat.color}`}>
                                <div className="text-[#351108] text-2xl mr-4">{stat.icon}</div>
                                <div>
                                    <h3 className="text-lg font-semibold text-[#351108]">{stat.label}</h3>
                                    <p className="text-2xl font-bold text-[#351108]">{stat.count}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md mb-10 mt-14">
                        <h2 className="text-xl font-semibold text-[#351108] mb-4">
                            {editing ? "Edit Order" : "Add Order"}
                        </h2>
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            <div>
                                <label htmlFor="customerId" className="block text-sm font-medium text-[#351108] mb-2">
                                    Customer ID
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label htmlFor="product" className="block text-sm font-medium text-[#351108] mb-2">
                                    Product
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label htmlFor="quantity" className="block text-sm font-medium text-[#351108] mb-2">
                                    Quantity
                                </label>
                                <input
                                    type="number"
                            ...
                            <div>
                                <label htmlFor="status" className="block text-sm font-medium text-[#351108] mb-2">
                                    Status
                                </label>
                                <select
                                    name="status"
                            ...
                            <div>
                                <label htmlFor="date" className="block text-sm font-medium text-[#351108] mb-2">
                                    Date
                                </label>
                                <input
                                    type="date"
                        ...
                        <button
                            ...
                            className="bg-[#351108] text-white px-6 py-3 rounded-lg shadow-md mt-9 transition-transform hover:scale-105 flex items-center"
                        >
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md mb-6">
                        <div className="flex items-center gap-4">
                            <div className="flex-1 relative">
                                ...
                                />
                                <FaSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#351108]" />
                            </div>
                            <div>
                                <select
                                    value={filterStatus}
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <h2 className="text-xl font-semibold text-[#351108] mb-4">Orders List</h2>
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-gray-200 text-[#351108] text-base leading-normal">
                            ...
                            <tbody className="text-[#351108] text-sm font-semibold">
                                    ...
                                    <tr key={order._id} className="border-b border-gray-200 hover:bg-gray-100">
                                        ...
                                        <td className="py-3 px-6 flex space-x-3">
                                            <button
                                                ...
                                                className="text-[#351108] hover:underline flex items-center"
                                            >
