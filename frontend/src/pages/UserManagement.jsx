            ...
            <div className="flex-1 bg-white">
                ...
                <div className="p-8">
                    <header className="flex justify-between items-center mb-8">
                        ...
                        <button
                            className="bg-[#351108] text-white px-6 py-3 rounded-lg shadow-md hover:bg-[#3f1c14] transition-all flex items-center"
                            onClick={() => {
                                setShowModal(true);
                                setIsEditing(false);
                                setFormValues({ name: "", email: "", password: "" });
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-8">
                        ...
                        <div className="bg-white shadow-xl rounded-lg border border-gray-200 p-6 flex items-center space-x-4 hover:shadow-md transition-all duration-300">
                            <FaUser className="text-3xl text-[#351108]" />
                            <div>
                                ...
                                {users.map((user) => (
                                    <tr key={user._id} className="hover:bg-gray-50 transition-all">
                                        ...
                                        <td className="px-6 py-4 flex justify-start space-x-3">
                                            <button
                                                className="text-[#351108] p-2 rounded-md transition duration-200"
                    ...
                    {showModal && (
                        <div className="fixed inset-0 bg-opacity-50 backdrop-blur-xs flex items-center justify-center p-4">
                            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                                ...
                                <input
                                    ...
                                    placeholder="Name"
                                    className="w-full mb-4 p-2 border border-gray-200 rounded-lg focus:outline-none focus:border-[#351108]"
                                />
                                <input
                                    type="email"
                                    name="email"
                                ...
                                <div className="flex justify-end space-x-3">
                                    ...
                                    <button
                                        className="bg-[#351108] text-white px-4 py-2 rounded-lg hover:bg-[#3f1c14] transition-all"
                                        onClick={handleSave}
                                    >
                                        Save
                                    </button>
