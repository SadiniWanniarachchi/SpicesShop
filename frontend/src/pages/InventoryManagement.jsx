        ...
        datasets: [
            {
                ...
                backgroundColor: [
                    '#6A994E', // Tea Leaf Green (this remains unchanged)
                    '#A7C957', // Lime Green (this remains unchanged)
                    '#386641', // Dark Forest Green (this remains unchanged)
                    '#BFD200', // Bright Yellow-Green (this remains unchanged)
                    '#D4E157', // Light Olive Green (this remains unchanged)
                ],
            ...
            <div className="flex-1 flex flex-col font-kulim">
                ...
                <div className="p-6 space-y-10 bg-white flex-1 overflow-y-auto">
                    ...
                    <header className="flex justify-between items-center mb-10 mt-8">
                        ...
                        <button
                            className="bg-[#351108] text-white px-6 py-3 rounded-lg shadow-md transition-transform hover:scale-105 flex items-center"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-white p-6 rounded-lg shadow-xl flex items-center">
                            <FaBox className="text-[#351108] text-3xl mr-4" />
                            <div>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-xl flex items-center">
                            <FaClipboardList className="text-[#351108] text-3xl mr-4" />
                            <div>
                            ...
                            <div className="bg-white p-6 rounded-md shadow-md">
                                ...
                                <div className="mt-4 flex justify-end space-x-4">
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-2 bg-[#351108] text-white rounded-md"
                                    >
                                        Save
                                    </button>
                                </div>
